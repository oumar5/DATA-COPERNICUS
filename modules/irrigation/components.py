...
def display_climate_indices(indices_list, time_labels, temp_values, precip_values):
    """
    Affiche les indices climatiques, la température et la précipitation sous forme de graphiques séparés.
